...
const LINE_DEFS = {
  ...
  PE: {
    ...
    cells: [
      ...
      { name: 'contractor_identification', len: 14 },
      { name: 'type_of_identification', len: 3 },
      { name: 'company_name_1', len: 35 },
      { name: 'company_name_2', len: 35 },
      { name: 'street_address_1', len: 35 },
      { name: 'street_address_2', len: 35 },
      { name: 'city', len: 35 },
      { name: 'postal_code', len: 9 },
      { name: 'country', len: 2 },
    ],
  },
  PH: {
  ...
  PV: {
    ...
    cells: [
      ...
      { name: 'target_quantity', len: 9 },
      { name: 'target_quantity_unit_edicode', len: 3 },
      { name: 'effective_quantity', len: 9 },
      { name: 'working_quantity_unit_edicode', len: 3 },
  ...
  IA: {
    ...
    cells: [
      { name: 'plot_number', len: 4 },
      { name: 'crop_reference', len: 4 },
      { name: 'expected_harvest_year', len: 4 },
      { name: 'event_reference', len: 32 },
      { name: 'analysis_slip_number', len: 35 },
      { name: 'analysis_laboratory_identification', len: 9 },
      { name: 'company_name_1', len: 35 },
      { name: 'company_name_2', len: 35 },
      { name: 'street_address_1', len: 35 },
      { name: 'street_address_2', len: 35 },
      ...
      { name: 'postal_code', len: 9 },
      { name: 'country', len: 2 },
      { name: 'analysis_date', len: 8, type: 'date' },
      { name: 'sampling_date', len: 8, type: 'date' },      
    ],
  },
  VR: {
    key: 'VR',
  ...
  VH: {
    ...
    cells: [
      { name: 'parcel_sequence_number', len: 4 },
      { name: 'cultivated_parcel_reference', len: 4 },
      { name: 'expected_harvest_year', len: 4 },
      { name: 'event_reference', len: 32 },
      { name: 'link_type', len: 3 },
      { name: 'reference_of_the_event_in_question', len: 32 },
      { name: 'previous_parcel_number', len: 4 },
      { name: 'harvest_year', len: 4 },
      { name: 'farm_identification', len: 17 },
      { name: 'identification_type', len: 3 },
      { name: 'company_name_1', len: 35 },
      { name: 'company_name_2', len: 35 },
      { name: 'street_address_1', len: 35 },
      { name: 'street_address_2', len: 35 },
      ...
      { name: 'postal_code', len: 9 },
      { name: 'country', len: 2 },
      { name: 'non_edi_parcel_information_1', len: 70 },
      { name: 'non_edi_parcel_information_2', len: 70 },      
    ],
  },
};
